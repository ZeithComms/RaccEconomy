...
public class TESRShop
		implements ITESR<TileShop>
{
	@Override
	public void render(TileShop tile, float partial, MatrixStack matrix, IRenderTypeBuffer buf, int lighting, int overlay, TileEntityRendererDispatcher renderer)
	{
		tile.onRender();
